    ...
    if response is not None:
        ...
        if view_function:
            if hasattr(view_function, '__name__'):
                ...
                # Class-based view
                error_log_data['error_view'] = f"{view_function.__class__.__module__}.{view_function.__class__.__name__}"
